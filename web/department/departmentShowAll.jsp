...
<div class="container">
    ...
    <div class="columns">
        <div class="column">
            <a href="/departments/new" class="button is-info">New</a>
        </div>
    </div>
    <div class="columns">
        <div class="column">
            ...
            <table class="table box diplay-table margin-auto">
                ...
                <c:forEach items="${departments}" var="a">
                    <tr>
                        <td><a href="${path}/departments/${a.getIdDepartment()}">${a.getIdDepartment()}</a></td>
                        <td>${a.getField()}</td>
                        ...
                        <td>
                            <form action="/departments/${a.getIdDepartment()}" method="POST">
