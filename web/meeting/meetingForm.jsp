        ...
        <div class="columns">
            <div class="column">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input is-info" name="day" type="text" placeholder="MM-DD-YYYY" value="${meeting.getDay()}">
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input is-info" name="time" type="text" placeholder="Text input" value="${meeting.getTime()}">
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input is-info" name="agenda" type="text" placeholder="Text input" value="${meeting.getAgenda()}">
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input is-info" name="minutes" type="text" placeholder="Text input" value="${meeting.getMinutes()}">
                    </div>
                </div>
