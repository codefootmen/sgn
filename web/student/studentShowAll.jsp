...
<div class="container">
    ...
    <div class="columns">
        <div class="column">
            <a href="/students/new" class="button is-info">New</a>
        </div>
    </div>
    <div class="columns">
        <div class="column">
            ...
            <table class="table box diplay-table margin-auto">
                ...
                <c:forEach items="${students}" var="a">
                    <tr>
                        <td><a href="${path}/students/${a.getIdStudent()}">${a.getIdStudent()}</a></td>
                        ...
                        <td>
                            <form action="/students/${a.getIdStudent()}" method="POST">
